...
class LibraryManagementDemo:
    ...
    def main():
        ...
        hobbit_copies = library.add_item("B001", "The Hobbit", "J.R.R. Tolkien", 2)
        dune_copies = library.add_item("B002", "Dune", "Frank Herbert", 1)
        library.add_item("M001", "National Geographic", "NatGeo Society", 3)
